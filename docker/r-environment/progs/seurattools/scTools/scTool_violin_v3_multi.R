scTool_violin_v3_multi <- function(seurat.obj, featuresvect, groupvar="orig.ident", 
                             outfold="QC/Violin/", customcol="#079FAB", id=NULL){
  ...
  print(VlnPlot(object = obj, features = featuresvect, pt.size = 0.2, log = TRUE, group.by = groupvar))
  dev.off()
